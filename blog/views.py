...
from .models import Comment, PostVote, CommentVote, Book, Category
...
def update_comment_view(request, id):
	...
	CommentOwner = get_object_or_404(user, username=com.author.username)
...
def update_post_view(request, id):
	...
	user = request.user
	PostOwner = get_object_or_404(user, username=pos.author.username)	
...
def readbook(request):
	...
	return render(request, 'blog/readbook.html', {"books": book, "categorys": categorys})


# class detailbook(ListView):
# 	model = Book
# 	template_name = 'blog/detailbook.html'
